...
print MAKEFILE "F90FLAGS = -Wall -g -O3 -ffpe-trap=zero -fbacktrace -fcheck=all -fbounds-check\n";
print MAKEFILE "LDFLAGS = -Wall -g -O3 -ffpe-trap=zero -fbacktrace -fcheck=all -fbounds-check\n\n";
#
# make
#
